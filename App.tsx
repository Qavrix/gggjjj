...
import { Loader2, FileCode, Folder, ExternalLink, ArrowLeft } from 'lucide-react';
...
const ReportFrameView = () => {
  ...
  // Construct the direct raw URL for GitHub Pages / Raw content
  // Since we are likely in a local preview or single page, we point to the raw content.
  // Ideally, reports are served via GitHub Pages for better rendering of JS in HTML reports.
  const rawReportUrl = `https://raw.githubusercontent.com/AlgoQ/backtesting-reports/main/${ROOT_DIR}/${botName}/${versionName}/${reportName}`;
